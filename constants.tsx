...
export const MODES = [
  ...
  { 
    ...
    { 
    id: InteractionMode.Map,
    name: 'Mind Map',
    description: 'Map out a topic',
    icon: (
  ...
  { 
    id: InteractionMode.Project,
    name: 'Project',
    description: 'Suggest project ideas',
    icon: (
